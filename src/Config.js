...
class Config {
  static get(applicationId, mount) {
    const cacheInfo = _cache.default.get(process.env.APP_ID);
    ...
    config.applicationId = process.env.APP_ID;
  ...
  get requestResetPasswordURL() {
    return `${this.publicServerURL}/apps/config/request_password_reset`;
  ...
  get passwordResetFailedURL() {
    return this.customPages.passwordResetFailed || `${this.publicServerURL}/apps/password_reset_failed.html`;
  }
